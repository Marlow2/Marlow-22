------------------------------------------------
-- This Source Was Developed By (BlackPink) @gg_gd.--
...
LuaTele = luatele.set_config{api_id=13099191,api_hash='0ff6b967c2b25942bf1ebcbb528c2664',session_name=TheBlackPink,token=Token}
function var(value)  
...
return {
Lock     = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[Kailer](https://t.me/hh_hq)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
elseif tonumber(msg.sender.user_id) == 5296758669 then
...
{
{text = 'Kailer ⁦', url='https://t.me/hh_hq'},
},
}
}
...
download('https://raw.githubusercontent.com/Marlow2/marlow22/main/BlackPink.lua','BlackPink.lua')
...
{{text =news,url = "https://t.me/hh_hq"}, },}}
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/hh_hq'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
data = {
{
{text = '- قناة السورس', url = 't.me/hh_hq'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/hh_hq'}, 
},
{
...
data = {
{
{text = '᥀ السورس .', url = 't.me/hh_hq'},{text = '᥀ لتنصيب بوت .', url = 't.me/gg_gd'}, 
},
{
